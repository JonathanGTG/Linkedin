...
<body>
  <header class="topbar">
    <a href="<?php echo e(url('/')); ?>" class="logo" aria-label="LinkedIn Learning">
    ...
    <div class="register-card">
      ...
      <form method="POST" action="<?php echo e(route('register')); ?>">
        ...
        <div class="field">
          ...
          <input id="name" type="text" name="name" value="<?php echo e(old('name')); ?>" autocomplete="name" required placeholder="Nama lengkap">
        </div>

        <div class="field">
          <label for="email">Email</label>
          <input id="email" type="email" name="email" value="<?php echo e(old('email')); ?>" autocomplete="email" required placeholder="email@example.com">
        </div>
...
<?php /**PATH D:\LinkedinLearning\resources\views/auth/register.blade.php ENDPATH**/ ?>