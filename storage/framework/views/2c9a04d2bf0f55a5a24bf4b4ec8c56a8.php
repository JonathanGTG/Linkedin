<?php $__env->startSection("title","Certifications — LinkedIn Learning"); ?>
      ...
      <div class="section-card">
        <div class="section-head">
          <div>
            ...
            <p class="section-desc"><?php echo e($section['desc']); ?></p>
          </div>
          <a class="show-all" href="<?php echo e(route('certifications.type', $section['type_slug'])); ?>">Show all</a>
        </div>

        <?php if($section['providers']->count() > 0): ?>
          <div class="provider-grid">
            <?php $__currentLoopData = $section['providers']->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $provider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <?php
              ...
              ?>
              <a class="provider-tile" href="<?php echo e(route('certifications.provider', [$section['type_slug'], $provider['slug']])); ?>">
                <span class="provider-logo">
                  <?php if($logo): ?>
                    <?php echo $logo; ?>

                  <?php else: ?>
                    <span class="provider-initial"><?php echo e($abbr); ?></span>
                  <?php endif; ?>
                </span>
                <span>
                  <div class="provider-name"><?php echo e($provider['name']); ?></div>
                </span>
              </a>
...
<?php echo $__env->make("layouts.app", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\LinkedinLearning\resources\views/certifications/index.blade.php ENDPATH**/ ?>