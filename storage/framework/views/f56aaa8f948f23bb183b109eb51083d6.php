...
<nav class="top-nav">
    ...
    <div class="nav-search">
        ...
        <form action="<?php echo e(route('browse')); ?>" method="GET" style="margin:0">
            <input type="text" name="q" value="<?php echo e(request('q')); ?>" placeholder="Cari keahlian, subjek, atau perangkat lunak">
        </form>
    </div>
...
<div class="page-wrapper">
    <aside class="sidebar" aria-label="Main navigation">
        <div class="sidebar-menu">
            <a href="<?php echo e(route('home')); ?>" class="nav-item <?php echo e(request()->routeIs('home') ? 'active' : ''); ?>" title="Home">
                <span class="nav-icon">
            ...
            <a href="<?php echo e(route('journey.index')); ?>" class="nav-item <?php echo e(request()->routeIs('journey*') ? 'active' : ''); ?>" title="My Career Journey">
                <span class="nav-icon">
                    <svg viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="<?php echo e(route('library')); ?>" class="nav-item <?php echo e(request()->routeIs('library*') ? 'active' : ''); ?>" title="My Library">
                <span class="nav-icon">
                    <svg viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="<?php echo e(route('browse')); ?>" class="nav-item <?php echo e(request()->routeIs('browse*') ? 'active' : ''); ?>" title="Content">
                <span class="nav-icon">
            ...
            <a href="<?php echo e(route('hands-on.index')); ?>" class="nav-item <?php echo e(request()->routeIs('hands-on*') ? 'active' : ''); ?>" title="Hands-On Tech">
                <span class="nav-icon">
            ...
            <a href="<?php echo e(route('certifications.index')); ?>" class="nav-item <?php echo e(request()->routeIs('certifications*') ? 'active' : ''); ?>" title="Certifications">
                <span class="nav-icon">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.1" stroke-linecap="round" stroke-linejoin="round">
...
<?php /**PATH D:\LinkedinLearning\resources\views/layouts/app.blade.php ENDPATH**/ ?>