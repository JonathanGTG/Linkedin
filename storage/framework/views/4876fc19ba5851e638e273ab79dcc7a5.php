...
<body>
  <nav>
    ...
    <div class="nav-actions">
      ...
      <a href="<?php echo e(route('register')); ?>" class="btn-join-nav">Join Now</a>
    </div>
  </nav>
  ...
  <main>
    <div class="hero-copy">
      ...
      <a href="<?php echo e(route('register')); ?>" class="btn-join-hero">Join Now</a>
...
<?php /**PATH D:\LinkedinLearning\resources\views/welcome.blade.php ENDPATH**/ ?>