<?php $__env->startSection("title", "Home - LinkedIn Learning"); ?>
...
<section class="li-carousel-section">
  ...
  <div class="li-carousel-overflow"><div class="li-carousel-track" id="inprogress-track">
    <?php $__currentLoopData = $inProgress; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enrollment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php $colors=[['#1d4ed8','#3b82f6'],['#166534','#16a34a'],['#7c2d12','#ea580c'],['#581c87','#9333ea'],['#0f172a','#334155'],['#0e7490','#06b6d4']];$pair=$colors[crc32($enrollment->course->id??$enrollment->course->title)%count($colors)]; ?>
    <div class="li-progress-card">
      <div class="li-progress-thumb">
        <?php if(!empty($enrollment->course->thumbnail)): ?>
          <img src="<?php echo e($enrollment->course->thumbnail); ?>" style="width:100%;height:100%;object-fit:cover;display:block" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'">
          <div class="li-progress-thumb-bg" style="display:none;background:linear-gradient(135deg,<?php echo e($pair[0]); ?> 0%,<?php echo e($pair[1]); ?> 100%)"><?php echo e(strtoupper(substr($enrollment->course->title,0,2))); ?></div>
        <?php else: ?>
          <div class="li-progress-thumb-bg" style="background:linear-gradient(135deg,<?php echo e($pair[0]); ?> 0%,<?php echo e($pair[1]); ?> 100%)"><?php echo e(strtoupper(substr($enrollment->course->title,0,2))); ?></div>
        <?php endif; ?>
      </div>
      <div class="li-progress-bar-wrap"><div class="li-progress-bar" style="width:<?php echo e($enrollment->progress_percent); ?>%"></div></div>
      <div class="li-progress-body">
        <div class="li-progress-title"><?php echo e($enrollment->course->title); ?></div>
        <div class="li-progress-meta"><?php echo e($enrollment->course->instructor_name); ?></div>
        <div class="li-progress-foot">
          <span class="li-progress-pct"><?php echo e($enrollment->progress_percent); ?>% complete</span>
          <a href="<?php echo e(route('course.show', $enrollment->course)); ?>" class="li-progress-cta">Continue →</a>
        </div>
      </div>
    </div>
...
<section class="li-carousel-section">
  <div class="li-carousel-header">
    <div class="li-carousel-title">Top picks for <?php echo e(auth()->user()->name); ?></div>
    <div class="li-carousel-nav">
  ...
  <div class="li-carousel-overflow"><div class="li-carousel-track" id="toppicks-track">
    <?php $__currentLoopData = $topPicks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo $__env->make("home._course_card",compact("course"), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  </div></div>
</section>
...
<section class="li-carousel-section">
  ...
  <div class="li-carousel-overflow"><div class="li-carousel-track" id="short-track">
    <?php $__currentLoopData = $shortCourses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo $__env->make("home._course_card",compact("course"), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  </div></div>
</section>

<?php if($saved->count() > 0): ?>
<section class="li-carousel-section">
  <div class="li-carousel-header">
  ...
  <div class="li-carousel-overflow"><div class="li-carousel-track" id="saved-track">
    <?php $__currentLoopData = $saved; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enrollment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo $__env->make("home._course_card",["course"=>$enrollment->course], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  </div></div>
</section>
<?php endif; ?>
...
<?php echo $__env->make("layouts.app", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\LinkedinLearning\resources\views/home/index.blade.php ENDPATH**/ ?>